...
G_modelTrainingInput_0 = "SELECT powerScoreAverage, criticalViolationAverage, noncriticalViolationAverage, lastPowerScore, lastCriticalCount, lastNoncriticalCount from Models where scoreAverage is not null and criticalViolationAverage is not null and noncriticalViolationAverage is not null and lastScore is not null and lastCriticalCount is not null and lastNoncriticalCount is not null order by inspection_date asc, inspection_id asc"
...
G_monthOfModels_2 = ("SELECT inspection_id, powerScoreAverage, criticalViolationAverage, noncriticalViolationAverage, lastPowerScore, lastCriticalCount, lastNoncriticalCount, resultPowerScore from Models " +
